...
/* enable exporting VLAN (and ICMP_TYPE) field in NetFlow v9 */
#define ENABLE_NF9_VLAN 1
...
/* Define to 1 if you have the declaration of `htonll', and to 0 if you don't.
   */
#define HAVE_DECL_HTONLL 0
